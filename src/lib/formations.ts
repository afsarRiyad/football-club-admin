...
export interface Formation {
  name: string;
  playerCount: number; // number of players per side (5, 7, 9, 11)
  slots: FormationSlot[];
}
...
/* ── 9v9 Formations (small-medium pitch) ── */
...
/* ── 5v5 Formations (futsal / mini pitch) ── */
...
/**
 * Field size definitions with their player counts.
 */
...
/**
 * Get all formation names (for backward compat).
 */
...
export function getFormation(name: string, playerCount?: FieldSize): Formation {
  ...
  // Fallback: first formation for the given size
